...
public interface CallbackPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void callbackTest()
    {
        callbackTest(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void callbackTest(java.util.Map<String, String> context)
    {
        _iceI_callbackTestAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> callbackTestAsync()
    {
        return _iceI_callbackTestAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> callbackTestAsync(java.util.Map<String, String> context)
    {
        return _iceI_callbackTestAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_callbackTestAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "callbackTest", null, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }

    default void printFibo(String s)
    {
        printFibo(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void printFibo(String s, java.util.Map<String, String> context)
    {
        _iceI_printFiboAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printFiboAsync(String s)
    {
        return _iceI_printFiboAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printFiboAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_printFiboAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printFiboAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printFibo", null, sync, null);
