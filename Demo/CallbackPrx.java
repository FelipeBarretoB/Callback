...
public interface CallbackPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void printMsg(String s)
    {
        printMsg(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void printMsg(String s, java.util.Map<String, String> context)
    {
        _iceI_printMsgAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printMsgAsync(String s)
    {
        return _iceI_printMsgAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printMsgAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_printMsgAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printMsgAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printMsg", null, sync, null);
