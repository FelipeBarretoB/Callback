...
{
    default void subscribe(CallbackPrx callback, String hostname)
    {
        subscribe(callback, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void subscribe(CallbackPrx callback, String hostname, java.util.Map<String, String> context)
    {
        _iceI_subscribeAsync(callback, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> subscribeAsync(CallbackPrx callback, String hostname)
    {
        return _iceI_subscribeAsync(callback, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> subscribeAsync(CallbackPrx callback, String hostname, java.util.Map<String, String> context)
    {
        return _iceI_subscribeAsync(callback, hostname, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_subscribeAsync(CallbackPrx iceP_callback, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void sendMessage(String msg, String hostname)
    {
        sendMessage(msg, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void sendMessage(String msg, String hostname, java.util.Map<String, String> context)
    {
        _iceI_sendMessageAsync(msg, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sendMessageAsync(String msg, String hostname)
    {
        return _iceI_sendMessageAsync(msg, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sendMessageAsync(String msg, String hostname, java.util.Map<String, String> context)
    {
        return _iceI_sendMessageAsync(msg, hostname, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sendMessageAsync(String iceP_msg, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default long fibo(long a)
    {
        return fibo(a, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long fibo(long a, java.util.Map<String, String> context)
    {
        return _iceI_fiboAsync(a, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> fiboAsync(long a)
    {
        return _iceI_fiboAsync(a, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> fiboAsync(long a, java.util.Map<String, String> context)
    {
        return _iceI_fiboAsync(a, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_fiboAsync(long iceP_a, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "fibo", null, sync, null);
        f.invoke(true, context, null, ostr -> {
